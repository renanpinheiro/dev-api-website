    ...
    <>
      ...
      <S.PrivacyPolicy>
        ...
        <S.ContainerDescription>
          <S.TitleDescription>
            <span>1. OBJETIVO DA POLÍTICA DE PRIVACIDADE</span>
            ...
            <p>
              ...
              informações, visando, sobretudo, prestar o melhor serviço para
              você. A DevApi reconhece que a sua privacidade é muito importante,
            ...
            <p>
              No decorrer da sua atividade, a DevApi coleta e trata dados
            ...
            <p>
              ...
              conhecimento desta Política de Privacidade e diligenciar pela
              devida compreensão.
            </p>
          ...
          <S.TitleDescription>
            ...
            <p>
              ...
              de dados pessoais, o qual pode ser a DevApi ou terceiro;
            </p>
            ...
            <p>
              <b>Dados pessoais sensíveis:</b> dado pessoal sobre origem racial
            ...
            <p>
              ...
              física, nomeadamente para analisar ou prever aspetos relacionados
              com o seu desempenho profissional, a sua situação económica,
              saúde, preferências pessoais, interesses, fiabilidade,
            ...
            <p>
              ...
              Proteção de Dados Pessoais), que dispõe sobre o tratamento de
            ...
            <p>
              ...
              deva assumir outro sentido, configura transmissão de dados
              pessoais uma operação de tratamento que envolva transmissão, por
              qualquer modo, dos referidos dados pessoais para uma entidade
              jurídica distinta da DevApi;
            </p>
          ...
          <S.TitleDescription>
            ...
            <p>
              ...
              políticas e procedimentos, devidamente mapeados. A presente
              política não substitui, nem se sobrepõe, a eventuais Acordos de
              Tratamento de Dados celebrados no caso concreto.
            </p>
          </S.TitleDescription>
          ...
          <S.TitleDescription>
            ...
            <p>
              <b>a) Lícito, leal e transparente</b> <br />
              Os dados pessoais são recolhidos e tratados de forma lícita, leal
              e transparente, nomeadamente dando garantia, aos titulares, de
              informações claras, precisas e facilmente acessíveis de quais os
              dados tratados, respetivos agentes, as finalidades do tratamento,
              e o seu prazo de conservação.
            </p>

            <p>
              <b>b) Finalidades determinadas, explícitas e legítimas</b> <br />
            ...
            <p>
              <b>d) Exatidão e atualização dos dados</b> <br />A exatidão e
              atualização dos dados é garantida através da disponibilização de
              canais específicos que permitem ao titular dos dados comunicar
              eventuais atualizações, bem como medidas de revisão e análise da
              qualidade dos dados, garantindo que os dados inexatos sejam
              apagados ou retificados.
              <br />
            ...
            <p>
              <b>e) Integridade e confidencialidade dos dados</b> <br />A DevApi
              procura garantir a segurança dos dados pessoais através da adoção
              de medidas técnicas e organizativas que permitem a proteção contra
              o tratamento não autorizado ou ilícito dos dados, bem como contra
              a sua perda, destruição ou danificação acidental.
              <br />A DevApi possui uma gama de controles de segurança de dados,
              definida de acordo com as necessidades do negócio e nas políticas
              de segurança em vigor, conforme informação disponibilizada na
              respetiva política de segurança da Informação.
            </p>

            <p>
              <b>f) Responsabilidade pelos dados</b> <br />A DevApi tem a
              responsabilidade de observar os princípios acima referidos,
              devendo comprovar os mesmos. Para tanto, promoverá a adoção de
              mecanismos contratuais que garantam o controle das políticas,
              procedimentos e mecanismos de controle e de atualização de dados
              pessoais utilizados pelos seus Operadores. a DevApi diligencia por
              prever contratualmente mecanismos de controle do cumprimento, por
              parte dos Operadores, das obrigações e limitações estabelecidas em
              matéria de proteção de dados.
            </p>
          </S.TitleDescription>

          <S.TitleDescription>
            <span>5. ACESSO AOS DADOS PESSOAIS</span>

            <p>
              Todos os seus dados são confidenciais e qualquer usos destes
              estará de acordo com a presente Política. A DevApi empreenderá
              todos os esforços razoáveis de mercado para garantir a segurança
              dos nossos sistemas e dos seus dados. Apenas os colaboradores da
              DevApu e fornecedores vinculados a estes termos terão acesso aos
              dados pessoais, e dentre estes, somente as pessoas com as devidas
              autorizações.
            </p>
          ...
          <S.TitleDescription>
            <span>6. COLETA DE DADOS</span>

            <p>
              <b>a) Como coletamos os dados que tratamos?</b> <br />
              ...
              <ul>
                <li>
                  I. Clientes, fornecedores, prospects ou integrantes da equipe
                  de prospects.
                </li>
                <li>
                ...
                <li>
                  III. Dados de pessoas físicas tratados nas operações
                  financeiras executadas para clientes da DevApi
                  (Controladores);
                </li>
                <li>
              ...
              digitais que a DevApi disponibiliza (incluindo email).
            ...
            <p>
              ...
              nomeadamente para efeitos de diligências pré-contratuais,
              celebração e execução de contratos de prestação de serviços de
              pagamento, de execução das operações de pagamento decorrentes,
              realização de transações ocasionais de pagamento, contratação e
              pagamento de serviços, controles de acesso/segurança, verificação
              de satisfação, marketing, eventos corporativos e prospecção de
              clientes.
              <br />
              <br />
          ...
          <S.TitleDescription>
            <span>7. DIREITOS DOS TITULARES DOS DADOS PESSOAIS</span>
            ...
            <p>
              ...
              apresentados os meios disponibilizados pela DevApi para que os
              titulares os possam invocar, sem prejuízo de outros direitos que
              possam estar legalmente previstos.
            </p>

            <p>
              <b>a) Direito a uma comunicação transparente</b> <br />
            ...
            <p>
              ...
              pessoais tratados pelo a DevApi, encaminhando o relatório dentro
              do prazo de 15 (quinze) dias, nos termos do artigo 19, parágrafo
              2º da LGPD. O relatório será encaminhado preferencialmente de
              forma eletrônica, o qual não acarretará custos ao titular, no
              entanto também poderá ser encaminhado por meio físico, mediante o
              pagamento de taxa razoável por este, tendo em conta os custos
              administrativos da operação.
            </p>

            <p>
              <b>c) Direito de correção</b> <br />A DevApi assegura que o
              titular dos dados possa retificar os seus dados pessoais,
              nomeadamente, quando estes estejam incorretos, inexatos ou
              desatualizados ou completá-los, caso se encontrem incompletos.
              <br />
              <br />A solicitação de retificação deverá ser encaminhada mediante
              o preenchimento do formulário de solicitação, a qual será
            ...
            <p>
              ...
              através do formulário de solicitação. Os pedidos de eliminação
              serão recepcionados pelo Encarregado (DPO), os quais serão
              analisados e, sendo considerados válidos à luz das normas legais
              aplicáveis, a DevApi processará o pedido.
              <br />
              <br />
              Caso os pedidos realizados não forem considerados válidos, tendo
              em vista a existência de obrigações legais e regulatórias da
              DevApi ou do Controlador manterem os dados, a DevApi não
              ...
              do pedido deverão ser encaminhadas pela DevApi ao titular no prazo
            ...
            <p>
              ...
              <br />
              A DevApi assegura os meios necessários para que o titular dos
              dados possa opor-se ao tratamento dos seus dados pessoais (com
              fundamento em uma das hipóteses de dispensa de consentimento).
              <br />
              <br />A DevApi analisará o pedido e, sendo considerado válido à
              luz das normas legais aplicáveis, cessará o tratamento em causa.
              Se os pedidos realizados não forem considerados válidos, a DevApi
              não os processará e comunicará ao titular dos dados os motivos
              associados a essa decisão no prazo máximo de 30 (trinta) dias após
            ...
            <p>
              ...
              <br />
              <br />
              A DevApi recolherá e conservará o consentimento de forma que
              ...
              durante todo o prazo subsequente necessário e lícito, nos termos
              ...
              <a href="mailto:contato@devapi.com.br">contato@devapi.com.br</a>,
            ...
            <p>
              ...
              <br />
              A DevApi assegura os meios necessários para que o titular dos
              dados possa receber os dados pessoais que lhe digam respeito e que
              tenha fornecido a DevApi em um formato estruturado, de uso
              corrente e de leitura automática.
              <br />
              <br />
              ...
              tratamento que lhe seja indicado pelo titular dos dados, sempre
              que tal seja tecnicamente possível.
              <br />
              <br />
              A DevApi recusará os pedidos de portabilidade sempre que estes
              prejudiquem os direitos e as liberdades de terceiros, ou se
              aplique outra limitação estabelecida em normas legais ou
              regulamentares aplicáveis.
              <br />
              <br />
              Mediante a solicitação de portabilidade pelo titular, a DevApi
              terá o prazo de 30 (trinta) dias para disponibilizar o arquivo em
              que os dados, viabilizando a realização da portabilidade.
            </p>
            ...
            <p>
              ...
              regulamentares aplicáveis. A DevApi reserva o direito de não
              acatar ao pedido sempre que entenda existir um enquadramento legal
              e que impeça o titular dos dados de exercer um direito que tenha
              invocado, observando os prazos acima estipulados.
              <br />
              <br />
          ...
          <S.TitleDescription>
            <span>9. RESPONSABILIDADES</span>

            <p>
              <b>9.1 DO USUÁRIO</b>

              <ol style={{ paddingTop: 10, paddingLeft: 30 }}>
                <li>
                ...
                <li>
                  ...
                  Usuário, ou, ainda, a qualquer terceiro, inclusive em virtude
                  do descumprimento do disposto nestes Termos de Uso e Política
                  de Privacidade ou de qualquer ato praticado a partir de seu
                  acesso à Internet, ao sítio e/ou Aplicativo.
                </li>
                <li>
                  A DevApi não poderá ser responsabilizado pelos seguintes
                  fatos:
                  <ol style={{ paddingTop: 10, paddingLeft: 30 }}>
                    ...
                    <li>
                      Vulnerabilidades ou instabilidades existentes nos sistemas
                      dos usuários;
                    </li>
            ...
            <p>
              ...
              <ol style={{ paddingTop: 10, paddingLeft: 30 }}>
                <li>
                  A DevApi, no papel de custodiante das informações pessoais dos
                  Usuários, deve cumprir todas as legislações inerentes ao uso
                ...
                <li>
                  ...
                  <a href="https://www.devapi.com.br">
          ...
          <S.TitleDescription>
            <p>
              <b>10. LINKS EXTERNOS</b>
              O site ou aplicativo da DevApi ou controlado pela DevApi poderá
              conter links para outros sites na Internet, redirecionando você a
              outro domínio. Esses sites externos não operarão sob esta Política
              de Privacidade, devendo ler as declarações de privacidade dos
              referidos sites.
              <br />
              <br />
          ...
          <S.TitleDescription>
            <span>11. DO USO DE COOKIES</span>
            <p>
              ...
              serviço que você usa.Você pode impedir a configuração de cookies
              ...
              desativação de cookies afetará a funcionalidade deste e de muitos
          ...
          <S.TitleDescription>
            <span>12. PARTILHA DE DADOS</span>
            <p>
              A DevApi poderá operar em conjunto com outras empresas na ampla
              gama de atividades de que participa, assim como poderá estar
              ...
              <ul style={{ paddingLeft: 20 }}>
                ...
                <li>
                  ...
                  fornecedores estarão sujeitos às obrigações de
          ...
          <S.TitleDescription>
            <span>13. MUDANÇAS NA POLÍTICA DE PRIVACIDADE</span>
            <p>
            ...
            <p>
              A DevApi recomenda a verificação frequente da Política de
              Privacidade, consultado a versão mais atual disponibilizada por
              meio do sítio (
              <a href="https://www.devapi.com.br">https://www.devapi.com.br</a>
              ).
            </p>
          </S.TitleDescription>

          <S.TitleDescription>
            <span>14. LEGISLAÇÃO APLICÁVEL</span>
            <p>
          ...
          <S.TitleDescription>
            <span>16. DIREITOS AUTORAIS</span>
            <p>
              A DevApi é proprietário de todos os direitos autorais, marcas,
              domínios, logotipos, aparência do produto, segredos de empresa,
              patentes e outros direitos de propriedade intelectual, associados
              ao produto Login no sistema e tecnologias associadas. É proibido o
              uso desses direitos autorais, marcas, domínios, logotipos,
              aparência do produto, segredos de empresa, patentes e outros
              direitos de propriedade intelectual sem autorização expressa da
              DevApi por meio do seu legítimo representante legal.
            </p>
          </S.TitleDescription>
          ...
          <S.TitleDescription>
            <span>18. RELACIONAMENTO COM TERCEIROS</span>
            <p>
              A DevApi não comercializa em qualquer hipótese, dados ou
          ...
          <S.TitleDescription>
            <span>19. ACEITAÇÃO DO TERMO E CONDIÇÕES DE USO</span>
            <p>
